...
- [ ] **Голосовые команды** - Whisper (HA add-on) когда поднимете OLLAMA
- [ ] **Больше устройств** - шторы, замки, медиа
- [ ] **Групповые команды** - "выключи весь свет на первом этаже"
- [ ] **Планировщик** - "включи свет через 10 минут"

### Долгосрочно

- [ ] **OLLAMA интеграция** - полностью локальный LLM
- [ ] **Голосовые ответы** - TTS
- [ ] **Мультиязычность** - English, Deutsch
