...
- [📦 Шаг 1: Установка зависимостей (WSL)](#шаг-1-установка-зависимостей-wsl)
- [🔐 Шаг 2: Установка SSH add-on в Home Assistant](#шаг-2-установка-ssh-add-on-в-home-assistant)
  - [2.1. Открыть Home Assistant](#21-открыть-home-assistant)
  - [2.2. Перейти в Add-ons](#22-перейти-в-add-ons)
  - [2.3. Найти и установить Terminal & SSH](#23-найти-и-установить-terminal-ssh)
  - [2.4. Настроить SSH add-on](#24-настроить-ssh-add-on)
  - [2.5. Запустить SSH add-on](#25-запустить-ssh-add-on)
- [📁 Шаг 3: Установка Samba add-on в Home Assistant](#шаг-3-установка-samba-add-on-в-home-assistant)
  - [3.1. Вернуться в Add-on Store](#31-вернуться-в-add-on-store)
  - [3.2. Найти и установить Samba share](#32-найти-и-установить-samba-share)
  - [3.3. Настроить Samba](#33-настроить-samba)
  - [3.4. Запустить Samba](#34-запустить-samba)
- [🌐 Шаг 4: Узнать IP адрес Home Assistant](#шаг-4-узнать-ip-адрес-home-assistant)
  - [В Home Assistant](#в-home-assistant)
- [💻 Шаг 5: Локальная настройка (WSL)](#шаг-5-локальная-настройка-wsl)
  - [5.1. Настроить SAMBA credentials](#51-настроить-samba-credentials)
  - [5.2. Обновить SSH config с вашим IP](#52-обновить-ssh-config-с-вашим-ip)
- [🌍 Шаг 6: Проброс портов на роутере](#шаг-6-проброс-портов-на-роутере)
  - [6.1. Войти в роутер](#61-войти-в-роутер)
  - [6.2. Найти раздел Port Forwarding](#62-найти-раздел-port-forwarding)
  - [6.3. Создать правило для SSH](#63-создать-правило-для-ssh)
  - [6.4. Создать правила для SAMBA](#64-создать-правила-для-samba)
  - [6.5. Сохранить настройки](#65-сохранить-настройки)
- [✅ Шаг 7: Проверка SSH подключения](#шаг-7-проверка-ssh-подключения)
  - [7.1. Первое подключение](#71-первое-подключение)
  - [7.2. Проверка работы](#72-проверка-работы)
  - [7.3. Выход](#73-выход)
- [📁 Шаг 8: Монтирование SAMBA](#шаг-8-монтирование-samba)
  - [8.1. Монтирование](#81-монтирование)
  - [8.2. Проверка](#82-проверка)
- [✅ Шаг 9: Финальная проверка](#шаг-9-финальная-проверка)
- [🎯 Начало работы](#начало-работы)
- [🆘 Решение проблем](#решение-проблем)
  - [SSH не подключается](#ssh-не-подключается)
  - [SAMBA не монтируется](#samba-не-монтируется)
  - [MCP не работает](#mcp-не-работает)
- [📝 Важные заметки](#важные-заметки)
  - [О SAMBA монтировании](#о-samba-монтировании)
  - [О SSH ключах](#о-ssh-ключах)
  - [О паролях](#о-паролях)
...
- **[COMMANDS.md](../reference/COMMANDS.md)** - Справочник всех команд
- **[WORKFLOW.md](../reference/WORKFLOW.md)** - Рабочий процесс разработки
