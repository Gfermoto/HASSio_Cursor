...
# Индикация (синий LED на GPIO2 - встроенный на ESP32)
...
- Используется встроенный синий LED на GPIO2 (есть на большинстве ESP32)
...
- 🔵 **Синий светодиод (GPIO2)** - встроенный на ESP32
  - Горит когда радар получает валидные данные
  - Мигает при детектировании целей
...
**Проверка работы:**
- 🔵 **Синий светодиод** должен загореться когда радар детектирует движение
