...
12. **🕸️ Граф зависимостей** - находит orphaned entities, циклы, impact analysis
13. **📈 Анализ сложности** - complexity scoring, рекомендации по рефакторингу
14. **🔄 Сравнить изменения** - risk assessment изменений между коммитами
