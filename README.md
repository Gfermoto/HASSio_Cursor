...
- 📊 **Config Analyzers** - граф зависимостей, анализ сложности, diff версий
...
./scripts/validate_yaml.sh  # Проверить YAML
...
│   ├── examples/         # Примеры
│   └── analyzers/        # 📊 Анализаторы конфигурации
├── scripts/              # ВСЕ скрипты
│   ├── setup.sh          # Установка
...
│   ├── validate_yaml.sh  # Валидация YAML
│   ├── validate_docs.py  # Валидация документации
│   └── analyzers/        # 📊 Анализаторы
│       ├── dependency.py # Граф зависимостей
...
7. Просмотр логов
8. Запуск аудита
9. **Проверить YAML** ← валидация конфигурации
10. **Проверить документацию** ← качество Markdown
11. Размонтировать

**📊 Анализ конфигурации:**

- **🕸️ Граф зависимостей** (пункт 12) - находит orphaned entities, циклы, impact analysis
- **📈 Анализ сложности** (пункт 13) - complexity scoring, рекомендации по рефакторингу
- **🔄 Сравнить изменения** (пункт 14) - risk assessment изменений между коммитами
...
Полная документация на GitHub Pages: **[https://gfermoto.github.io/HASSio_Cursor][docs]**

### Основные разделы

- 📖 [Полная инструкция установки](docs/setup/SETUP.md) - пошаговое руководство
- ⚡ [Быстрый старт](docs/setup/quickstart.md) - начало за 5 минут
- 📋 [Справочник команд](docs/reference/COMMANDS.md) - все команды и скрипты
- 🔄 [Рабочий процесс](docs/reference/WORKFLOW.md) - как работать с проектом
- 🔒 [Безопасность](docs/guides/security.md) - защита от утечек данных
- 🔍 [Первый аудит](docs/guides/first-audit.md) - анализ вашей системы
- 📊 **[Анализаторы конфигурации](docs/analyzers/README.md)** - граф зависимостей, сложность, diff
...
- **MCP:** ✅ Работает
- **SSH:** 🔧 Требует настройки (см. [docs/setup/SETUP.md](docs/setup/SETUP.md))
- **SAMBA:** 🔧 Требует настройки (см. [docs/setup/SETUP.md](docs/setup/SETUP.md))
